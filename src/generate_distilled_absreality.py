...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="./inference_results/absreality-nolcm",
    ...
    parser.add_argument("--unet_path", type=str, default="./results/nscc_ckpt_60000_absreality_distill", required=False, help='path to the unet model')
    parser.add_argument("--scheduler", type=str, default="", required=False, help='type of scheduler')
