...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="./inference_results/absreality",
    ...
    parser.add_argument("--scheduler", type=str, default=None, required=False, help='type of scheduler')
